...
import calzaImage from "/src/assets/calza.png";
import logo from "/src/assets/flash.png";
import calzaImage2 from "/src/assets/calza2.png";
import logo2 from "/src/assets/equipeco.png";
import calzaImage3 from "/src/assets/calza3.png";
import logo3 from "/src/assets/nike.png";
                ...
                <div style={{ minHeight: '85vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#f7f7f7' }}>
                    <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', backgroundColor: '#ffffff', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)',  }}>
                        ...
                        <div style={{ flex: '1 1 50%', backgroundColor: '#f2f2f2', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '600px' }}>
                            ...
                            {/* Nombre Producto */}
                            <h3 className='font-bold text-2xl'>Calza Termica Flash Masculina</h3>
                            ...
                            <Button 
                                ...
                                onPress={() => agregarAlCarrito({ id: 1, nombre: 'Calza Termica Flash Masculina', precio: 13499.99 })}
                            >
                                Agregar al Carrito
                            </Button>
                        </div>
                ...
                <div style={{ minHeight: '85vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#f7f7f7' }}>
                    <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', backgroundColor: '#ffffff', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)',  }}>
                        ...
                        <div style={{ flex: '1 1 50%', backgroundColor: '#f2f2f2', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '600px' }}>
                            ...
                            {/* Nombre Producto */}
                            <h3 className='font-bold text-2xl'>Calza Termica EquipeCO Femenina</h3>
                            <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
                            ...
                            <Button 
                                ...
                                type='submit'
                                className='mt-5 text-lg w-80'
                                onPress={() => agregarAlCarrito({ id: 2, nombre: 'Calza Termica EquipeCO Femenina', precio: 13499.99 })}
                            >
                                Agregar al Carrito
                            </Button>
                        </div>
                ...
                <div style={{ minHeight: '85vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#f7f7f7' }}>
                    <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', backgroundColor: '#ffffff', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)',  }}>
                        ...
                        <div style={{ flex: '1 1 50%', backgroundColor: '#f2f2f2', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '600px' }}>
                            ...
                            {/* Nombre Producto */}
                            <h3 className='font-bold text-2xl'>Calza Termica Corta Unisex</h3>
                            <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
                            ...
                            <Button 
                                ...
                                type='submit'
                                className='mt-5 text-lg w-80'
                                onPress={() => agregarAlCarrito({ id: 3, nombre: 'Calza Termica Corta Unisex', precio: 13499.99 })}
                            >
                                Agregar al Carrito
                            </Button>
                        </div>
